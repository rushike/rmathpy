...
from infinite_series import *


# r = Series([105656585857654654654646564565464654654, 4788676876876843243242431658657596856757658765875876576575, 5])
r = IntegerSeries(10, 4)
n = r.nums()
for s in n:
       print(s)
